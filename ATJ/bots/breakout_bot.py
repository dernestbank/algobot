...
price_deviation_tolerance = 10 #for zone analysis
sr_period = 6 #$ support and resistance period
...
def get_last_closed_candle():
    current_candle = mt5.copy_rates_from_pos(symbol, timeframe, 1, 1) #get the last two candles (current and previous)
    return current_candle[0]
